    ...
    <v-card :loading="loading">
      ...
      <v-container grid-list-xs>
        <v-row dense>
          ...
          <v-col cols="12" xs="12" sm="12" md="6" lg="6" v-if="leave.type == 'VL-Half' || leave.type == 'SL-Half' || leave.type == 'PTO-Half'">
            <v-text-field
              label="Time From"
          ...
          <v-col cols="12" sm="6">
            <v-btn :disabled="leave.recommending_approval == 'Approved'" color="success" block @click="approveLeave">Approve</v-btn>
          </v-col>
          <v-col cols="12" sm="6">
            <v-btn :disabled="leave.recommending_approval == 'Disapproved'" color="error" block @click="disapproveLeave">Disapprove</v-btn>
          </v-col>
        </v-row>
      </v-container>
    </v-card>
